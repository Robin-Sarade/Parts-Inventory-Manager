# -*- coding: utf-8 -*-
"""
Created on Tue Feb 28 18:47:21 2023
...
FORM_CLASS,_= loadUiType(resource_path('parts.ui'))
...
class Main(QMainWindow,FORM_CLASS):
    ...
    def Handel_Buttons(self):
        ...
        self.chk_btn.clicked.connect(self.LEVEL)
        self.update_btn.clicked.connect(self.UPDATE)
        self.del_btn.clicked.connect(self.DELETE)
        self.add_btn.clicked.connect(self.ADD)
        self.nxt_btn.clicked.connect(self.NEXT)
    ...
    def GET_DATA(self):
        # connect to sqlite3 database and fill GUI table with date.
        
        db=sqlite3.connect(resource_path('parts_.db'))
        cursor=db.cursor()
    ...
    def NAVIGATE(self):
        ...
        self.nbr_holes.setText(str(val[5]))
    ...
    def UPDATE(self):
        ...
        number_of_holes_=self.nbr_holes.text()
